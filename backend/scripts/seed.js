...
const hacks = [
  {
    ...
    description: 'An AI tool that automatically detects potential bugs and style inconsistencies in code.',
  ...
  },
  {
    ...
    description: 'A comprehensive UI component library for rapid development across multiple platforms.',
    videoUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
