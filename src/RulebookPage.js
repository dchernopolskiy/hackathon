        ...
        <main className="flex-grow p-8 overflow-y-auto">
          ...
          <RuleSection title="General Rules" icon={FileText}>
            <ol className="list-decimal list-inside space-y-4 text-gray-300">
              ...
              <li>
                Use appropriate language and content in all communications.
              </li>
              <li>Do not share harmful or inappropriate links.</li>
              <li>Harassment or abuse of any kind will not be tolerated.</li>
              <li>
                No spam or self-promotion without permission from Hackathon
                staff.
              </li>
              <li>
                Adhere to the submission rules posted in the designated area.
              </li>
              <li>
                Report any concerns or issues to the Hackathon staff
                immediately.
              </li>
            </ol>
          </RuleSection>
          ...
          <RuleSection title="Submission Guidelines" icon={FileText}>
            <ol className="list-decimal list-inside space-y-4 text-gray-300">
              ...
              <li>
                Project Purpose: Explain what issue your project addresses.
              </li>
              <li>
                Implementation: Detail the technologies used and deployment
                process.
              </li>
              <li>
                Challenges: Discuss obstacles encountered during development.
              </li>
              <li>Learnings: Share new skills or knowledge gained.</li>
              <li>
                Future Plans: Outline potential future developments for your
                project.
              </li>
            </ol>
          </RuleSection>
            ...
            <ul className="list-decimal list-inside space-y-4 text-gray-300">
              ...
              <li>
                ...
                <ol className="list-disc list-inside ml-6 mt-2 space-y-2">
                  ...
                  <li>
                    Technologies used (languages, platforms, APIs, hardware,
                    etc.)
                  </li>
                  <li>Unique aspects you're proud of</li>
                  <li>
                    A video demo ≤ 3 minutes showcasing your project's features
                  </li>
                </ol>
              </li>
              <li>
                Engage the judges by including a link to try out your project if
                applicable.
              </li>
              <li>
                Focus on demonstrating your project in action rather than
                relying heavily on PowerPoint presentations.
              </li>
            </ul>
          </RuleSection>
        </main>
