...
const MySubmissionsPage = () => {
  ...
  const sampleHack = {
    ...
    description:
      "Developed an AI-driven predictive maintenance system for a major automotive manufacturer, reducing downtime by 30% and maintenance costs by 25%.",
    videoUrl:
      "https://www.youtube.com/embed/5GOibtZZzy4?list=PLjCLg32Aazj1BFCA3HLmAnlpGr5g22UKA",
    images: [
      ...
      <div className="flex flex-grow">
        ...
        <main className="flex-grow p-8 overflow-y-auto">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link
              to="/submit-hack"
              className="bg-purple-500 text-white px-4 py-2 rounded-full font-bold hover:bg-purple-600 transition duration-300 flex items-center"
            >
